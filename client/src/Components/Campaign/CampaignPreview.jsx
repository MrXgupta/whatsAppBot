...
const CampaignPreview = ({message, mediaFile}) => {
    ...
    return (
        <div className="w-full flex justify-center items-start">
            <div
                className="w-[320px] h-[640px] bg-black rounded-[40px] border-[14px] border-black shadow-lg overflow-hidden relative">
                ...
                <div className="w-full h-full bg-white flex flex-col">
                    <div className="bg-emerald-600 text-white px-4 py-2 flex items-center pt-5">
                        <img
                            src={`https://ui-avatars.com/api/?name=${user.name || user.email || 'User'}&background=ffffff&color=4caf50`}
                        ...
                        <div>
                            <div className="flex items-center gap-1 text-sm font-medium">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-blue-400"
                    ...
                    <div
                        className="flex-1 bg-[url('https://w0.peakpx.com/wallpaper/818/148/HD-wallpaper-whatsapp-background-cool-dark-green-new-theme-whatsapp.jpg')] bg-cover p-3 overflow-y-auto">
                        <div
                            className="bg-white rounded-lg shadow px-3 py-2 text-sm max-w-[80%] text-gray-800 overflow-hidden whitespace-pre-wrap break-words">
                            {mediaFile && (
                                <img
