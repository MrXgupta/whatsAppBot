...
import { Smartphone, RefreshCw, AlertCircle, CheckCircle, Wifi, WifiOff } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-6">
                    {/* Status card */}
                    <div className={`mb-8 p-6 rounded-xl border-2 border-${statusInfo.color}-200 bg-${statusInfo.color}-50`}>
                    ...
                    {initStatus === "scanning" && qr && !qrScanned && (
                        <div className="flex flex-col items-center mb-8">
                            ...
                            <p className="text-sm text-gray-500 max-w-md text-center">
                                Scan this QR code with your phone to link your WhatsApp account. The QR code will expire after a few minutes.
                            </p>
                        </div>
                    )}
                    ...
                    <div className="flex justify-between items-center mt-8 mb-4">
                        <div className={`h-2 flex-1 rounded-full ${initStatus === "searching" || initStatus === "scanning" || initStatus === "connecting" || initStatus === "ready" ? "bg-green-500" : "bg-gray-200"}`}></div>
                        <div className="mx-2"></div>
                        <div className={`h-2 flex-1 rounded-full ${initStatus === "scanning" || initStatus === "connecting" || initStatus === "ready" ? "bg-green-500" : "bg-gray-200"}`}></div>
                        <div className="mx-2"></div>
                        <div className={`h-2 flex-1 rounded-full ${initStatus === "connecting" || initStatus === "ready" ? "bg-green-500" : "bg-gray-200"}`}></div>
                        <div className="mx-2"></div>
                        <div className={`h-2 flex-1 rounded-full ${initStatus === "ready" ? "bg-green-500" : "bg-gray-200"}`}></div>
                    </div>
