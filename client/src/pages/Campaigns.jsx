                ...
                <div className="p-6">
                    ...
                    {showForm && (
                        <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-indigo-500 transition-all">
                            ...
                            <div className="mb-4">
                                <label className="block mb-1 text-sm font-medium text-gray-600">Select Contact
                                    Group</label>
                                <select
                            ...
                            <div className="mb-4 grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (value >= 20 && value <= 60) setMinDelay(value);
                                        }}
                                        className="w-full px-3 py-2 border rounded"
                                        min={20}
                                        max={60}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            const value = Number(e.target.value);
                                            if (value >= minDelay && value >= 0) setMaxDelay(value);
                                        }}
                                        className="w-full px-3 py-2 border rounded"
                                        min={minDelay}
                                    />
